# Validação de paridade — btg-pl-total
...
python validation/compare-results.py \
  --expected validation/dashboards/btg-pl-total/powerbi/expected-results/kpis.csv \
  --actual   validation/dashboards/btg-pl-total/web/api-results/kpis.csv \
